...
function hapusSiswa(no_induk, nama) {
    if (confirm(`⚠️ Arsipkan / Keluarkan siswa: ${nama} (${no_induk})?\n\nSistem tidak akan menghapus data secara permanen, melainkan hanya akan mengubah statusnya menjadi 'Keluar'.`)) {
