        ...
        <div class="p-6 max-w-7xl mx-auto space-y-6 pb-20">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                ...
                <div class="bg-white border border-[#E2E8F0] hover:border-[#000080] rounded-xl shadow-sm hover:shadow-md transition-all transform hover:-translate-y-1 relative overflow-hidden flex flex-col justify-between group">
                    ...
                    <div class="p-5 flex-1 cursor-pointer" onclick="window.location.href='../../views/admin/monitoring_siswa_list.php?kelas=<?= $kelas['id_kelas'] ?>&tahun=<?= $id_tahun ?>&arsip=1'">
                        <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="grid grid-cols-2 border-t border-[#E2E8F0] divide-x divide-[#E2E8F0]">
                        <a href="../../views/admin/monitoring_siswa_list.php?kelas=<?= $kelas['id_kelas'] ?>&tahun=<?= $id_tahun ?>&arsip=1" class="block text-center py-2.5 text-[10px] font-bold text-[#000080] hover:bg-blue-50 transition-colors uppercase tracking-wider">
                            Daftar Siswa
                        </a>
                        <a href="../../views/admin/rekapitulasi_kelas.php?kelas=<?= $kelas['id_kelas'] ?>&tahun=<?= $id_tahun ?>&arsip=1" class="block text-center py-2.5 text-[10px] font-bold text-amber-600 hover:bg-amber-50 transition-colors uppercase tracking-wider">
                            Rekap Kelas
                        </a>
                    </div>
                </div>
