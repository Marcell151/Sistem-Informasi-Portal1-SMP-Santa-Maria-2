...
// Analitik 3: Total Surat SP & Jumlah Siswa (Differentiated)
$sp_stats_exec = fetchOne("
    SELECT 
        (COUNT(CASE WHEN status_sp_kelakuan != 'Aman' THEN 1 END) +
         COUNT(CASE WHEN status_sp_kerajinan != 'Aman' THEN 1 END) +
         COUNT(CASE WHEN status_sp_kerapian != 'Aman' THEN 1 END)) as total_surat,
        COUNT(DISTINCT CASE WHEN status_sp_kelakuan != 'Aman' OR status_sp_kerajinan != 'Aman' OR status_sp_kerapian != 'Aman' THEN no_induk END) as total_siswa
...
if (isKepsek()) {
    ...
    // Analitik 5: Sebaran SP per Jenjang Kelas (Executive Strategy)
    ...
    // Analitik 7: Tren Bulanan (Sederhana)
