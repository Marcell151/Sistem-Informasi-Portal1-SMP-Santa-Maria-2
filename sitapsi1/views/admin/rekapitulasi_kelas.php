...
if ($id_kelas) {
    ...
    $siswa_kelas = fetchAll("
        SELECT 
            ...
            -- Status SP (Tetap tampilkan status SP terakhir/akumulasi karena SP bersifat kumulatif tahunan)
    ...
    <div class="flex-1 overflow-auto lg:ml-64">
        ...
        <div class="bg-white border-b border-[#E2E8F0] px-6 pl-16 lg:pl-6 py-4 sticky top-0 z-30 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div class="flex items-center space-x-4">
                <?php if ($is_arsip): ?>
                <a href="arsip_tahun.php?tahun=<?= $filter_tahun ?>&tab=tatib" class="p-2 rounded-lg text-slate-400 hover:text-slate-600 hover:bg-slate-50 transition-colors">
