...
<div class="flex h-screen overflow-hidden">
    ...
    <div class="flex-1 overflow-auto lg:ml-64">
        ...
        <div class="bg-white border-b border-[#E2E8F0] px-6 pl-16 lg:pl-6 py-4 sticky top-0 z-30 flex items-center space-x-4">
            <a href="<?= $is_arsip ? 'arsip_tahun.php?tahun=' . $filter_tahun . '&tab=tatib' : 'monitoring_siswa.php' ?>" class="p-2 rounded-lg text-slate-400 hover:text-slate-600 hover:bg-slate-50 transition-colors">
