...
<body class="bg-slate-50 min-h-screen flex flex-col items-center justify-center p-4 py-10 relative overflow-x-hidden">
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div
            class="absolute -top-24 -right-24 w-96 h-96 bg-[#000080] rounded-full mix-blend-multiply filter blur-3xl opacity-5">
        </div>
        <div
            class="absolute -bottom-24 -left-24 w-96 h-96 bg-blue-400 rounded-full mix-blend-multiply filter blur-3xl opacity-10">
        </div>
    </div>
    ...
    <div class="w-full max-w-md relative z-10 mb-6">
        ...
        <div class="text-center mb-8">
            <div
                class="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-white shadow-md border border-slate-100 mb-4 p-2">
        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 p-8">
            ...
            <?php if ($error): ?>
                <div
                    class="bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-xl mb-6 flex items-center shadow-sm">
            ...
            <form action="../../actions/login_ortu_process.php" method="POST" class="space-y-5">
                ...
                <div>
                    <label class="block text-xs font-extrabold text-slate-600 mb-2 uppercase tracking-wider">Username
                        Akun Wali Murid</label>
                    <div class="relative">
                ...
                <div>
                    <label
                        class="block text-xs font-extrabold text-slate-600 mb-2 uppercase tracking-wider">Password</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <svg class="w-5 h-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                stroke-width="2">
                        ...
                        <button type="button" onclick="togglePassword()"
                            class="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 hover:text-[#000080] transition-colors">
                ...
                <div class="flex items-center space-x-2 pt-1">
                    <input type="checkbox" name="remember_me" id="remember"
                        class="w-4 h-4 rounded border-slate-300 text-[#000080] focus:ring-[#000080]" <?= $saved_username ? 'checked' : '' ?>>
                    <label for="remember"
                        class="text-xs text-slate-500 font-medium cursor-pointer hover:text-slate-700 transition-colors">Ingat
                        Username dan Password saya</label>
                </div>

                <div class="pt-2">
                    <button type="submit"
                        class="w-full py-3.5 bg-[#000080] text-white rounded-xl font-extrabold text-sm shadow-lg shadow-blue-900/20 hover:bg-blue-900 transition-all flex items-center justify-center group">
                        Masuk ke Portal
    ...
    <div class="w-full max-w-md text-center relative z-10">
        <a href="../../index.php"
            class="inline-flex items-center justify-center px-6 py-2.5 bg-white border border-slate-200 text-slate-600 hover:text-[#000080] hover:border-[#000080] rounded-full text-sm font-bold shadow-sm transition-all group">
            <svg class="w-4 h-4 mr-2 text-slate-400 group-hover:text-[#000080] transition-colors" fill="none"
                stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
